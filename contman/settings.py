...
STATICFILES_DIRS = (
    ...
    '/home/alejandro/Documents/projects/cman/contman/static/',
...
SECRET_KEY = '5sea%@7u@v03@m@xv_=*l-=_1q@3g4wv3=@+y3^0^vs9$m%@jj'
    ...
    'disable_existing_loggers': False,
     'formatters': {
        ...
        'simple': {
         ...
         'std': {
             'format' : '[%(levelname)s] %(asctime)s-3s %(name)-4s %(message)s',
             'datefmt' : '%Y-%m-%d %H:%M:%S'
         }
    },
    'filters': {
