...
class EntryViewTestCase(TestCase):
    ...
    def test_report_date_list(self):
        self.assertEquals(report_by_month(self.convert_to_date("2012-03-01"),self.convert_to_date("2012-07-21")),self.expected_month_first_last_empty)
        self.assertEquals(report_by_month(self.convert_to_date("2012-04-01"),self.convert_to_date("2012-05-21")),self.expected_month_first_last_match)


    def test_report_day_list(self):
        self.assertEquals(report_by_date(self.convert_to_date("2012-04-22"),self.convert_to_date("2012-05-12")),self.expected_date)
